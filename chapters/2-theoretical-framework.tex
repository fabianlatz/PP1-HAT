...
\end{itemize}
Dieses Modell versucht, eine Balance zwischen sozialen Dimensionen (Kultur, Teilen) und technischen Dimensionen (Automatisierung) herzustellen und betont, dass die Kultur die Basis für alle weiteren Prinzipien bildet~\cite{jha23}.

\section{Soziotechnische Systemtheorie}

\DO ist ein klassisches Beispiel für ein soziotechnisches System.
% TODO Source? Günter Ropohl
...
Praktiker warnen eindringlich davor, \DO fälschlicherweise ausschließlich auf Werkzeuge und Automatisierung zu reduzieren~\cite{luz18}.
...
Der Erfolg von \DO hängt also weniger von der technischen Umsetzung ab, als von der Etablierung einer Kultur, die Silos aufbricht und gemeinsame Ziele in den Vordergrund stellt.
% TODO Silos erklären
Die Literatur identifiziert dabei konsistent eine Reihe von Kernattributen, die eine \DO-Kultur auszeichnen:
...
\begin{itemize}
    ...
    \item \emph{Geteilte Verantwortung:} Teams übernehmen gemeinsam die Verantwortung für den gesamten Lebenszyklus einer Anwendung.
    \item \emph{Vertrauen:} Ein hohes Maß an Vertrauen zwischen den Teams und Individuen als Grundlage für effektive Zusammenarbeit.
\end{itemize}
Diese Attribute sind nicht isoliert zu betrachten, sondern bilden das Gerüst für das übergeordnete Ziel: den Aufbau einer \emph{kollaborativen Kultur}, in der Teams nicht gegeneinander, sondern miteinander für den Erfolg des Produkts arbeiten~\cites{luz18,san18}.
