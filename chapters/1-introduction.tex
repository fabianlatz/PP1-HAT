...
Die Fähigkeit, neue Produktfeatures in kurzen Zyklen zu liefern und die Softwarequalität kontinuierlich zu verbessern, ist zu einem entscheidenden Wettbewerbsvorteil geworden~\cites{jha23,aza23a}.

\DO verspricht genau das: die Beschleunigung von Lieferzyklen und die Steigerung der Stabilität durch die Überwindung traditioneller Differenzen zwischen Entwicklungs"= (Dev) und Betriebsteams (Ops).
...
Vielmehr handelt es sich um einen tiefgreifenden soziokulturellen Prozess, dessen Hauptziel der Aufbau einer kollaborativen Kultur ist~\cite{luz18}.
