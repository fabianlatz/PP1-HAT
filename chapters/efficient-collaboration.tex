...
\begin{figure}[hb]
	\centering
	\subfloat[\centering Code-First-Ansatz]{\label{fig:code-first}\input{gfx/flowchart-code-first.tikz}}
	\qquad
	\subfloat[\centering \AFA]{\label{fig:api-first}\input{gfx/flowchart-api-first.tikz}}
