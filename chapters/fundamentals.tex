...
Eine \ac{API}"=Spezifikation in der Design"=Phase zu entwerfen erfordert jedoch ein hohes Maß an Abstraktion, Kenntnis über die Anforderungen an das System und die technischen Möglichkeiten, die zur Verfügung stehen~\cite[362]{de23}.
