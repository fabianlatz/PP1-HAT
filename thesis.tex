...
% Only include if no figures, tables etc. are included
...
\include{chapters/2-theoretical-framework}
\include{chapters/3-social-cultural-factors}
\include{chapters/4-barriers}
